...
//       <span id="icon" className="navbar-toggler-icon"><img id="iconImage" src="assets/menuCircle.png"/> </span>
  ...
  <ul className="navbar-nav float-right">
         <li className="nav-item active">
           <a class="nav-link list-inline" href="#">Home <span className="sr-only">(current)</span></a>
         </li>
         <li class="nav-item">
...
<a class="navbar-brand" href="#">
       {/* <img src="/docs/4.0/assets/brand/bootstrap-solid.svg" width="30" height="30" class="d-inline-block align-top" alt=""> Ky</a> */}
    </nav>
